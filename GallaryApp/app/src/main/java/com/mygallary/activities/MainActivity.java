...
import com.mygallary.SelectAlbumBottomSheet;
import com.mygallary.activities.base.SharedMediaActivity;
import com.mygallary.adapters.AlbumsAdapter;
import com.mygallary.adapters.MediaAdapter;
...
import com.mygallary.data.base.FilterMode;
import com.mygallary.data.base.SortingMode;
import com.mygallary.data.base.SortingOrder;
import com.mygallary.util.Affix;
import com.mygallary.util.AlertDialogsHelper;
...
import com.mygallary.views.GridSpacingItemDecoration;
...
public class MainActivity extends SharedMediaActivity {
  ...
  private void setDrawerTheme() {
    ...
    /** CLICK LISTENERS **/
    //findViewById(R.id.ll_drawer_Donate).setVisibility(View.GONE);
    ...
    findViewById(R.id.ll_drawer_About).setVisibility(View.GONE);
    ...
    //findViewById(R.id.ll_drawer_hidden).setVisibility(View.GONE);
