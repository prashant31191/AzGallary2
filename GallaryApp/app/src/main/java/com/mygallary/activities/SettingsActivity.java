...
import com.mygallary.util.ColorPalette;
import com.mygallary.util.PreferenceUtil;
import com.mygallary.util.SecurityHelper;
import com.mygallary.util.StaticMapProvider;
import com.mygallary.util.ThemeHelper;

import uz.shift.colorpicker.LineColorPicker;
import uz.shift.colorpicker.OnColorChangedListener;

import static com.mygallary.util.ThemeHelper.AMOLED_THEME;
import static com.mygallary.util.ThemeHelper.DARK_THEME;
import static com.mygallary.util.ThemeHelper.LIGHT_THEME;
...
public class SettingsActivity extends ThemedActivity {
    ...
    private void baseThemeDialog(){
        ...
        dialogBuilder.setPositiveButton(getString(R.string.ok_action).toUpperCase(), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                SP.putInt(getString(com.mygallary.R.string.preference_base_theme), getBaseTheme());
                setTheme();
            }
        });
    ...
    private void setTheme(){
        ...
        /** BackGround **/
        findViewById(com.mygallary.R.id.setting_background).setBackgroundColor(getBackgroundColor());

        /** Cards **/
        int color = getCardBackgroundColor();
        ((CardView) findViewById(com.mygallary.R.id.general_setting_card)).setCardBackgroundColor(color);
        ((CardView) findViewById(com.mygallary.R.id.theme_setting_card)).setCardBackgroundColor(color);
        ((CardView) findViewById(com.mygallary.R.id.preview_picture_setting_card)).setCardBackgroundColor(color);
        ((CardView) findViewById(com.mygallary.R.id.video_setting_card)).setCardBackgroundColor(color);
        ...
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(com.mygallary.R.string.settings));
        setScrollViewColor(scr);
        updateViewswithAccentColor(getAccentColor());
