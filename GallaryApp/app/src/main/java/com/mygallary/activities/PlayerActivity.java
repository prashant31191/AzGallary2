...
import com.mygallary.util.ContentHelper;
import com.mygallary.util.Measure;
import com.mygallary.util.player.DemoPlayer;
import com.mygallary.util.player.ExtractorRendererBuilder;
import com.mygallary.util.player.HlsRendererBuilder;
import com.mygallary.views.VideoControllerView;
...
public class PlayerActivity extends ThemedActivity implements SurfaceHolder.Callback,
  ...
  private void initUI(){
    ...
    setStatusBarColor();
    setNavBarColor();
    setRecentApp(getString(com.mygallary.R.string.app_name));
  }
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    getMenuInflater().inflate(com.mygallary.R.menu.menu_video_player, menu);

    menu.findItem(com.mygallary.R.id.action_share).setIcon(getToolbarIcon(GoogleMaterial.Icon.gmd_share));
    menu.findItem(com.mygallary.R.id.rotate_layout).setIcon(getToolbarIcon(GoogleMaterial.Icon.gmd_screen_rotation));
    return true;
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      ...
      case com.mygallary.R.id.action_share:
        ...
        startActivity(Intent.createChooser(share, getString(com.mygallary.R.string.send_to)));
        return true;

      case com.mygallary.R.id.action_settings:
        startActivity(new Intent(getApplicationContext(), SettingsActivity.class));
        return true;

      case com.mygallary.R.id.rotate_layout:
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.mygallary.R.layout.activity_player);

    FrameLayout root = (FrameLayout) findViewById(com.mygallary.R.id.root);
    ...
    shutterView = findViewById(com.mygallary.R.id.shutter);

    videoFrame = (AspectRatioFrameLayout) findViewById(com.mygallary.R.id.video_frame);
    surfaceView = (SurfaceView) findViewById(com.mygallary.R.id.surface_view);
    surfaceView.getHolder().addCallback(this);

    mediaController = new CustomMediaController(this, this);

    mediController_anchor =  findViewById(com.mygallary.R.id.media_player_anchor);
  ...
  public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
      ...
      Toast.makeText(getApplicationContext(), com.mygallary.R.string.storage_permission_denied,
  ...
  public void onError(Exception e) {
    ...
    if (e instanceof UnsupportedDrmException) {
      ...
      errorString = getString(Util.SDK_INT < 18 ? com.mygallary.R.string.error_drm_not_supported
          : unsupportedDrmException.reason == UnsupportedDrmException.REASON_UNSUPPORTED_SCHEME
          ? com.mygallary.R.string.error_drm_unsupported_scheme : com.mygallary.R.string.error_drm_unknown);
      ...
      if (decoderInitializationException.decoderName == null) {
        if (decoderInitializationException.getCause() instanceof DecoderQueryException) {
          errorString = getString(com.mygallary.R.string.error_querying_decoders);
        } else if (decoderInitializationException.secureDecoderRequired) {
          errorString = getString(com.mygallary.R.string.error_no_secure_decoder,
              decoderInitializationException.mimeType);
        } else {
          errorString = getString(com.mygallary.R.string.error_no_decoder,
              decoderInitializationException.mimeType);
        }
      } else {
        errorString = getString(com.mygallary.R.string.error_instantiating_decoder,
