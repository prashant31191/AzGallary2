package com.mygallary.fragments;
...
import com.mygallary.activities.PlayerActivity;
import com.mygallary.activities.SingleMediaActivity;
...
public class VideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.mygallary.R.layout.fragment_video, container, false);

        ImageView picture = (ImageView) view.findViewById(com.mygallary.R.id.media_view);
        IconicsImageView videoInd = (IconicsImageView) view.findViewById(com.mygallary.R.id.icon);
