...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.mygallary.R.layout.card_album, parent, false);
    ...
    public void onBindViewHolder(final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        Glide.with(holder.picture.getContext())
                ...
                .centerCrop()
                .error(com.mygallary.R.drawable.ic_error)
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            picture = (ImageView) itemView.findViewById(com.mygallary.R.id.album_preview);
            selectedIcon = itemView.findViewById(com.mygallary.R.id.selected_icon);
            layout = itemView.findViewById(com.mygallary.R.id.linear_card_text);
            name = (TextView) itemView.findViewById(com.mygallary.R.id.album_name);
            nPhotos = (TextView) itemView.findViewById(com.mygallary.R.id.album_photos_count);
        }
    }
}
