package com.mygallary.adapters;
...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.mygallary.R.layout.card_photo, parent, false);
    ...
    public void onBindViewHolder(final MediaAdapter.ViewHolder holder, int position) {
        ...
        if(f.isVideo()) {
            ...
            holder.path.setTextColor(ContextCompat.getColor(holder.path.getContext(), com.mygallary.R.color.md_dark_primary_text));
            holder.path.setBackgroundColor(
                    ColorPalette.getTransparentColor(
                            ContextCompat.getColor(holder.path.getContext(), com.mygallary.R.color.md_black_1000), 100));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            layout = itemView.findViewById(com.mygallary.R.id.media_card_layout);
            imageView = (ImageView) itemView.findViewById(com.mygallary.R.id.photo_preview);
            gifIcon = itemView.findViewById(com.mygallary.R.id.gif_icon);
            icon = (IconicsImageView) itemView.findViewById(com.mygallary.R.id.icon);
            path = (TextView) itemView.findViewById(com.mygallary.R.id.photo_path);
        }
    }
}
