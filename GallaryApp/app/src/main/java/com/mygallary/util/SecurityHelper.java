...
public class SecurityHelper {
    ...
    public void updateSecuritySetting(){
        ...
        this.activeSecurity = SP.getBoolean(context.getString(com.mygallary.R.string.preference_use_password), false);
        this.passwordOnDelete = SP.getBoolean(context.getString(com.mygallary.R.string.preference_use_password_on_delete), false);
        this.passwordOnHidden = SP.getBoolean(context.getString(com.mygallary.R.string.preference_use_password_on_hidden), true);
        this.passwordValue = SP.getString(context.getString(com.mygallary.R.string.preference_password_value), "");
    }

    public EditText getInsertPasswordDialog(final ThemedActivity activity, AlertDialog.Builder passwordDialog){

        final View PasswordDialogLayout = activity.getLayoutInflater().inflate(com.mygallary.R.layout.dialog_password, null);
        ...
        final EditText editxtPassword = (EditText) PasswordDialogLayout.findViewById(com.mygallary.R.id.password_edittxt);
